...
**Objetivo:** Desarrollar un `observatorio`
de `sequía multiescala` para Chile que ayude a mitigar los `impactos agrícolas` y
`ecológicos`.

[https://odes-chile.org](https://odes-chile.org)
